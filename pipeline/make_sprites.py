...
CREATURES = {
    "kindlpup": {
        ...
        "palette": [
            "#16121A",  # outline
            "#221C28",  # shadow band (near-black, violet-shifted)
            "#3C3738",  # dark warm-grey coat lit band
            "#5C504E",  # rim-warmed coat
            "#A89A8C",  # light grey-tan chest / socks / brows
            "#6E625E",  # shadowed marking mid-tone
            "#8E6E72",  # pink-grey inner ear
            "#FF6B1A",  # core glow
